...
.directive('content', ['$parse', '$timeout', '$ionicScrollDelegate', function($parse, $timeout, $ionicScrollDelegate) {
  return {
    restrict: 'E',
    replace: true,
    template: '<div class="scroll-content test-class"><div class="scroll" ng-transclude></div></div>',
    transclude: true,
    require: '^?navView',
    scope: {
      onRefresh: '&',
...
.directive('navBar', ['$ionicViewService', '$rootScope', '$animate', '$compile', 
  ...
  return {
    ...
    template: '<header class="bar bar-header nav-bar invisible" ng-if="!hide_header">' +
        '<div class="buttons"> ' +
